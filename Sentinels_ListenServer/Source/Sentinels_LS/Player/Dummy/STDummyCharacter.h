...
#include "STEnums.h"
#include "STDummyCharacter.generated.h"
...
UCLASS()
class SENTINELS_LS_API ASTDummyCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	static ASTDummyCharacter* FindByID(UObject* WorldContextObject, FUniqueNetIdRepl PlayerID);
